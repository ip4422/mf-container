...
const remotesApp1Domain = process.env.REACT_APP_APP1_DOMAIN.replace(/\/+$/, '')

const remotes = {
  // remoteApp1 - the name of the remote application inside container
  // remoteApp1Domain - the domain of the remote application
  ...
  // remote application
  remoteApp1: `app1@${remotesApp1Domain}/remoteEntry.js`
}
